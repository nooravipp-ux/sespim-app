...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <form class="form-sample" method="post" action="{{route('serdik.update.pasangan')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="tempat_nikah" value="{{$data->tempat_nikah}}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12">Tanggal Nikah</label>
                                    <div class="col-sm-12">
                                        <input type="date" class="form-control" name="tanggal_nikah" value="{{$data->tanggal_nikah}}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="alamat_rumah" value="{{$data->alamat_rumah}}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12">Nama Ibu Pasangan</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="nama_ibu_pasangan" value="{{$data->nama_ibu_pasangan}}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12">Nama Ayah Pasangan</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="nama_ayah_pasangan" value="{{$data->nama_ayah_pasangan}}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-12">Alamat Orangtua Pasangan</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="alamat_orang_tua_pasangan" value="{{$data->alamat_orang_tua_pasangan}}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
