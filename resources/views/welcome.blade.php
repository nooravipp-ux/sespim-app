@extends('layouts.app')
@section('title', 'Website Resmi SESPIM POLRI')
@section('content')
<!-- home page slider -->
<div class="homepage-slider">
	<!-- single home slider -->
	@foreach($newestPost as $nw)
	<div class="single-homepage-slider homepage-bg-1" style="background-image: url('{{asset('assets/img/post-images/'. $nw->image_banner)}}');">
		<div class="container">
			<div class="row">
				...
				<div class="single-latest-news">
					<a href="{{route('front.post.detail', ['id' => $post->id, 'slug' => $post->slug])}}">
						<div class="latest-news-bg news-bg-1">
							<img src="{{asset('assets/img/post-images/'.$post->image_banner)}}" alt="banner-image" />
						</div>
					</a>
