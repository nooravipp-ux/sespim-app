                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li><a href="#">KABAR SESPIM</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{route('front.kabar-sespim', ['id' => 1])}}">KEGIATAN</a></li>
                                ...
                                <li><a href="{{route('front.galeri')}}">GALERI</a>
                                </li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-box pages">
                        <img src="{{asset('assets/img/footer-logo.png')}}" alt="" width="230" height="160">
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="footer-box pages">
